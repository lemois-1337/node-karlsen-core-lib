 ...
 *
 * @param {string} prefix Network prefix. E.g.: 'karlsentest'.
 */
...
const karlsenNetworks = ['karlsen', 'karlsendev', 'karlsenreg', 'karlsentest', 'karlsensim'];
...
karlsenNetworks.map((str) => {
  addNetwork({
    ...
    privatekey: 0x80, // privatekey prefix -- must be 128 or toWIF() result will not match with karlsen
    scripthash: 0x05,
